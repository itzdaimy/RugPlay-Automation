  ...
  if (balanceCurrent !== null) {
    ...
    const summary = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: "Max Win Streak", value: `${Math.max(...history.map(h => h.winStreak || 0))}`, inline: true },
        { name: "Max Loss Streak", value: `${Math.max(...history.map(h => h.lossStreak || 0))}`, inline: true }
      )
      .setTimestamp();
